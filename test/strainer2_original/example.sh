...
echo 'example should take <<1 minute to run'
../../src/strain_detect -r strains/Bacteroides_ovatus_1001283st1_B8_1001283B150210_160208.fna.gz -a strains/Bacteroides_ovatus_1001283st1_B8_1001283B150210_160208.scrubbed_kmers.gz -B target_metagenomes.txt -o strains/Bacteroides_ovatus_1001283st1_B8_1001283B150210_160208.kmer_hits.gz -j 12
echo 'STEP3: complete'
